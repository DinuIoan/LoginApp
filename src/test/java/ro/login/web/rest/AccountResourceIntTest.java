package ro.login.web.rest;
import ro.login.config.Constants;
import ro.login.LoginApp;
import ro.login.domain.Authority;
import ro.login.domain.PersistentToken;
import ro.login.domain.User;
import ro.login.repository.AuthorityRepository;
import ro.login.repository.PersistentTokenRepository;
import ro.login.repository.UserRepository;
import ro.login.security.AuthoritiesConstants;
import ro.login.service.MailService;
import ro.login.service.dto.UserDTO;
import ro.login.web.rest.errors.ExceptionTranslator;
import ro.login.web.rest.vm.KeyAndPasswordVM;
import ro.login.web.rest.vm.ManagedUserVM;
import ro.login.service.UserService;
