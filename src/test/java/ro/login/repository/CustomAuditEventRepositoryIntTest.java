package ro.login.repository;

import ro.login.LoginApp;
import ro.login.config.Constants;
import ro.login.config.audit.AuditEventConverter;
import ro.login.domain.PersistentAuditEvent;
...
import static ro.login.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
